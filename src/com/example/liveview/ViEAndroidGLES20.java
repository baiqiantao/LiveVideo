...
public class ViEAndroidGLES20 extends GLSurfaceView implements Renderer//GLSurfaceView.Renderer
{
	private static String TAG = "AppEGL";
	...
	private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
		...
		private static int[] s_configAttribs2 = { EGL10.EGL_RED_SIZE, 4, EGL10.EGL_GREEN_SIZE, 4, EGL10.EGL_BLUE_SIZE, 4, EGL10.EGL_RENDERABLE_TYPE,
	...
	public void RegisterNativeObject(long nativeObject) {
		nativeFunctionLock.lock();
		Log.w(TAG, "RegisterNativeObject");
		;
